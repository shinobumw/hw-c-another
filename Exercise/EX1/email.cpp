...
void sol() 
{
    ...
    for (int i = 0; i < n; i++) {
        ...
        if (*s) {
            cout << "\"" << line << "\"" << " has invalid character." << '\n';
            continue;
        }
        ...
        if (addr[count].name[0] == '\0') {
            cout << "\"" << line << "\"" << " has invalid username." << '\n';
            continue;
        }
